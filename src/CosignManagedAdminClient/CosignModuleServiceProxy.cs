...
namespace CosignManagedAdminClient
{
    ...
    internal class CosignModuleServiceProxy : ModuleServiceProxy
    {
        public PropertyBag GetAppSettings()
        {
            return (PropertyBag)Invoke("GetAppSettings");
        }

        public void UpdateAppSettings(PropertyBag updatedSettings)
        {
            Invoke("UpdateAppSettings", updatedSettings);
        }
    }
}